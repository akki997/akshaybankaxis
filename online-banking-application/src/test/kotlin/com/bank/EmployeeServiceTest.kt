...
class EmployeeServiceTest {
    ...
    fun getAllCustomerTest() {
        ...
        {
            var loan = Loan("160000012360","Education Loan",200000.0,10.0,5.0,100000.0,5000.0)
            Mockito.`when`(loanRepository!!.findByCustomerAccountNumber("160000012360")).thenReturn(loan)
            assertEquals(loan,employeeService!!.getLoanDetails("160000012360"))
        }
       @Test
        fun getEmployeeTest(){
            var employee= Employee("E01","Akshay","9999512360","Manager")
