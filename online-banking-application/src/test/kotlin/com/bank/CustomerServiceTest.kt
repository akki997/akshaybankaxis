...
class CustomerServiceTest {
    ...
    fun updateTransactionHistoryTest(){
        var transaction= Transaction("160000012360","1234",500, LocalDateTime.now(),"+500")
    ...
    fun getTransactionHistoryTest(){
        var transaction= Transaction("160000012360","1234",500, LocalDateTime.now(),"+500")
        var transaction2= Transaction("160000012360","1234",1000, LocalDateTime.now(),"+500")
        var transaction3= Transaction("160000012360","1234",1500, LocalDateTime.now(),"+500")
...
/* @Test
    fun getLoanTest(){
        val loan= Loan()
          customerService!!.getLoan("160000012360","Education Loan",20000.0,5.0)
        Mockito.verify(loanRepository, atMostOnce())!!.save(loan)
    }*//*
